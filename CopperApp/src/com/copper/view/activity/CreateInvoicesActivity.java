...
public class CreateInvoicesActivity extends ActionBarActivity implements
	...
	private EditText subject, tax, desposite, discount;
		...
		findViewById(R.id.selectClient).setOnClickListener(
				new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						RequestMethod.getClient(CreateInvoicesActivity.this,
								MyPref.getInstance(CreateInvoicesActivity.this)
										.readPrefs(MyPref.USER_ID),
								CreateInvoicesActivity.this);
						...
						builder.setSingleChoiceItems(items, position,
								new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface arg0,
										...
										if (position == 4) {
											findViewById(R.id.selectDueDateLAyout)
		...
		if (subject.getText().toString().trim().length() <= 0) {
			...
			RequestMethod.createInvoice(this, "", subject.getText().toString()
					...
					((EditText) findViewById(R.id.descriptionEditText))
							...
							.getText().toString().trim(), p_id, tax.getText()
							.toString().trim(), dueDateTextView.getText()
							.toString().trim(), issueDateTextView.getText()
							.toString().trim(), this, false);
	...
	private void addActionBar() {
		customActionView = LayoutInflater.from(CreateInvoicesActivity.this)
	...
	public void onCallBack(int taskType, Object object) {
		// TODO Auto-generated method stub
		if (taskType == RequestResponseType.REQUEST_TYPE_CREATE_INVOICE) {
			finish();
