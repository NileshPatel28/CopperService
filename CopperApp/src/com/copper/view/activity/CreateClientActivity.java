...
public class CreateClientActivity extends ActionBarActivity implements
		CallBackListener {
	...
	void saveRecord() {
		if (firstName.getText().toString().trim().length() <= 0) {
			...
			RequestMethod.createClient(mContext, items[position], firstName
	...
	private void addActionBar() {
		customActionView = LayoutInflater.from(CreateClientActivity.this)
	...
	public void onCallBack(int taskType, Object object) {
		// TODO Auto-generated method stub
		if (taskType == RequestResponseType.REQUEST_TYPE_CREATE_CLIENT) {
			if (object != null) {
