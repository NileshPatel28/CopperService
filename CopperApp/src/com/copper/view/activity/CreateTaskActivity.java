...
public class CreateTaskActivity extends ActionBarActivity implements
	...
	void saveRecord() {
		if (title.getText().toString().trim().length() <= 0) {
			...
			RequestMethod.createBasicTask(mContext, title.getText().toString()
	...
	private void addActionBar() {
		customActionView = LayoutInflater.from(CreateTaskActivity.this)
	...
	public void onCallBack(int taskType, Object object) {
		// TODO Auto-generated method stub
		if (taskType == RequestResponseType.REQUEST_TYPE_CREATE_TASK) {
			finish();
		}
	}
